...
class JadwalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('jadwalAdmin',compact('datas','data_murid', 'kemaren','mingguan'))->with('i');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($cektanggal > 0){
            ...
            if($cekjam > 0){
                return redirect('admin-jadwal')->withErrors('Booking gagal, Harap Masukkan waktu Booking yang lain');
            }else{
            Jadwal::create($data);
