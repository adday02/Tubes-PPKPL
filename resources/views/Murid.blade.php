            ...
            <div class="page-title">
              <div class="title_left">
                @if(auth()->user()->level=="murid")
                  <h3>Profile Murid</h3>
                @elseif(auth()->user()->level=="lulusan")   
                <h3>Profile Lulusan</h3> 
                @endif
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Paket<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="id_paket" required="required" class="form-control" readonly value="{{auth()->user()->id_paket}}">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 offset-md-8">
                          <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" 
                            data-target="#edit-murid{{auth()->user()->nik}}" ><i class="fa fa-pencil"> Edit</i></button>
                      </div>
                  </div>
                </div>
              </div>
...
<!-- Modal Ubah Data  -->
<div id="edit-murid{{auth()->user()->nik}}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('murid.update', auth()->user()->nik)}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="row form-group">
                 ...
                 <div class="row form-group">
                    ...
                    <div class="col-sm-8">        
                        <input type="tel" name="no_hp" class="form-control" value="{{ auth()->user()->no_hp }}" required pattern="[0-9]{11,12}" title="Masukkan No HP sebanyak 11-12 Digit dengan format Nomor">
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="alamat" class="form-control" value="{{ auth()->user()->password }}" required>
                    </div>
                </div>
