                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" 
                                                data-target="#edit-jadwal{{$data->id_jadwal}}" ><i class="fa fa-pencil"></i></button>
                                            </div>
                                            <div class="col-sm-2">    
        ...
        <div class="modal-content">
            ...
            <form action="{{route('admin-jadwal.store')}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
               ...
               <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="input100" type="text" name="nik" required>
                            <option disabled="" selected=""value="">--Pilih Murid--</option>
...
<div id="edit-jadwal{{$data->id_jadwal}}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <!-- body modal -->
            <div class="modal-body">
            <form action="{{route('admin-jadwal.update', $data->id_jadwal)}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
