  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Data Instruktur Mengemudi</h3>
              </div>
            </div>
            @if($errors->any())
                    ...
                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                 <div style="float:right; margin-right:15px">
                                        <button type="button" class="btn btn-success" data-toggle="modal" 
                                                data-target="#tambah-instruktur" >Tambah Instruktur</button>
                                    </div>
                                <thead>
                                    <tr>
                                        <th>No</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" 
                                                data-target="#edit-instruktur{{$data->id_instruktur}}" ><i class="fa fa-pencil"></i></button>
                                            </div>
                                            </div>
                                            <div class="col-sm-2">
                                            <div class="col-sm-2">    
                                            <form action="{{route('admin-instruktur.destroy', $data->id_instruktur)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
   ...
   <script src="js/murid/vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="js/murid/build/js/custom.min.js"></script>
      ...
      <div id="tambah-instruktur" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- konten modal-->
        <div class="modal-content">
            <!-- heading modal -->
            <div class="modal-header">
                <h5 class="modal-title" id="mediumModalLabel">Tambah Instruktur</h5>
            ...
            <form action="{{route('admin-instruktur.store')}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row form-group">
                    <label class="col-sm-4 control-label">Id Instruktur</label>
                    <div class="col-sm-8">        
                        <input type="tel" name="id_instruktur" class="form-control" required pattern="[0-9]{7,11}" title="Masukkan Id Instruktur sebanyak 7-11 Digit dengan format Nomor">
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="password" class="form-control" required pattern=".{8}" title="Maskkan Password Minimal 8 Digit">
                    </div>
                </div>
...
@foreach ($datas as $data)
<!-- Modal Ubah Data  -->
<div id="edit-instruktur{{$data->id_instruktur}}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- konten modal-->
        <div class="modal-content">
            <!-- heading modal -->
            ...
            <!-- body modal -->
            <div class="modal-body">
            <form action="{{route('admin-instruktur.update', $data->id_instruktur)}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="row form-group">
                    <label class="col-sm-4 control-label">Id Instruktur</label>
                    <div class="col-sm-8">        
                        <input type="number" name="id_instruktur" class="form-control" value="{{ $data->id_instruktur }}" readonly>
                    </div>
                </div>
                ...
                <div class="row form-group">
                 ...
                 <div class="row form-group">
                    <label class="col-sm-4 control-label">No HP</label>
                    <div class="col-sm-8">        
                        <input type="number" name="no_hp" class="form-control" value="{{ $data->no_hp }}" required pattern="[0-9]{11,12}" title="Masukkan No HP sebanyak 11-12 Digit dengan format Nomor">
                    </div>
                </div>
